    ...
    switch (node->type)
    {
        ...
        case FUNCTION:
        {
            ...
            switch (node->data.stat)
            {
                case ln:
                {
                    ...
                    return new_node(OPERATOR, MUL, diff_node(node->right_son), new_node(VARIABLE, DIV, tree_cpy(node->right_son), the_node));
                }
                ...
                case cos:
                {
                    ...
                    Node* the_the_new_node = new_node(FUNCTION, sin, tree_cpy(node->right_son));
                ...
                case sin:
                {
                  //printf("sindiff");
                    ...
                    Node* the_the_new_node = new_node(FUNCTION, cos, tree_cpy(node->right_son));
                ...
                case sh:
                {
                    Node* the_the_new_node = new_node(FUNCTION, ch, tree_cpy(node->right_son));
                ...
                case ch:
                {
                    Node* the_the_new_node = new_node(FUNCTION, sh, tree_cpy(node->right_son));
                ...
                case tg:
                {
                    Node* the_cos_node = new_node(FUNCTION, cos, tree_cpy(node->right_son));
                ...
                case ctg:
                {
                    Node* the_cos_node = new_node(FUNCTION, sin, tree_cpy(node->right_son));
        ...
        case OPERATOR:
        {
            switch (node->data.stat)
            {
                ...
                case DEGREE:
                {
                    Node* the_node  = new_node(FUNCTION, ln,/* tree_cpy*/node->left_son);
...
Node* simple_node(Node* tested_node)
{
    ...
    switch (tested_node->data.stat)
    {
        case MUL:
        {
            ...
            else if (tested_node->right_son->data.i_num == 1)
            {
            ...
            else if (tested_node->left_son->data.i_num == 1)
            {
        ...
        case DEGREE:
        {
            if (tested_node->left_son->data.i_num == 1)
            {
                optimized_node = tested_node->left_son;
        ...
        case MINUS:
        {
            ...
            else if (tested_node->right_son->data.i_num == 0)
            {
                optimized_node = tested_node->left_son;
